...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        super().reduce_health(amount) #reduce health of fireant by amount
...
class TankAnt(ContainerAnt):
    ...
    def action(self, gamestate):
        ...
        # perform the contained ant action
        if self.ant_contained:
            self.ant_contained.action(gamestate)
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        while current_place != None:
            ...
            if ant:
                if ant.is_container:
                    if ant.ant_contained and not ant.ant_contained.is_doubled:
                        ant.ant_contained.double()
                    if not ant.is_doubled:
                        ant.double()
                elif not ant.is_doubled:
                    ant.double()
